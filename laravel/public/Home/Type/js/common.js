 ...
 * 咨询的翻页函数
 */
function gotoPage_qst(page, id, type)
{
  Ajax.call('question.php?act=gotopage', 'page=' + page + '&id=' + id + '&type=' + type, gotoPageResponse_qst, 'GET', 'JSON');
}

function gotoPageResponse_qst(result)
{
